# workflows/opportunity — Opportunity

**Статус:** только структура (PHASE 00). Temporal workflows не реализованы.
**Реализация:** PHASE 07, 11–12.

## Назначение

Формирование и оценка Opportunity: market context, Business Model Router, Judges, решение владельца.
