...
| 02    | PostgreSQL Foundation                                         | [02_postgresql_foundation.md](02_postgresql_foundation.md) | Реализована, ожидает approval владельца ([отчёт](02_postgresql_foundation.report.md)) |
